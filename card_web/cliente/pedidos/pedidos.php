...
<h2 align="center">Tus Pedidos <b><?php echo $custRow['nombre']; ?></b>.</h2>
<div>
	<table border=1 class="tabla_articulos">
		...
		<tbody>
			...
			<tr>
				...
				<td><a href="admin_pedido.php?action=removePedido&id_pedido=<?php echo $pedido->getIdPedido()?>" onclick="return confirm('¿Cancelar pedido?')"><img class="eliminar" src="../../assets/img/eliminar.png" alt="eliminar" width="40px" height="40px"></a></td>
			</tr>
			<?php } }else{ ?>
				<tr><td colspan="9"><h4>No existen pedidos.</h4></td></tr>
			<?php } ?>
		</tbody>
	</table>
</div>
